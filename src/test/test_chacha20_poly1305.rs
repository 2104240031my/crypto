...
pub fn test_chacha20_poly1305() -> usize {
    let mut err: usize = 0;
    err = err + test_chacha20_poly1305_0();
    err = err + test_chacha20_poly1305_1();
    return err;
}

fn test_chacha20_poly1305_inner(k: &[u8], n: &[u8], a: &[u8], p: &[u8], c: &[u8], t: &[u8]) -> usize {

    let mut out1: [u8; 512] = [0; 512];
    let mut out2: [u8; 16] = [0; 16];
    let mut err: usize = 0;

    let mut chacha20_poly1305: ChaCha20Poly1305 = ChaCha20Poly1305::new(k).unwrap();

    chacha20_poly1305.encrypt_and_generate(n, a, p, &mut out1[..c.len()], &mut out2[..]).unwrap();
...
fn test_chacha20_poly1305_0() -> usize {
    ...
    return test_chacha20_poly1305_inner(&k[..], &n[..], &a[..], &p[..], &c[..], &t[..]);

}

fn test_chacha20_poly1305_1() -> usize {

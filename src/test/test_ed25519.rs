...
pub fn test_ed25519() -> usize {
    let mut err: usize = 0;
    err = err + test_ed25519_1();
    err = err + test_ed25519_2();
    err = err + test_ed25519_3();
    err = err + test_ed25519_4();
    err = err + test_ed25519_5();
    return err;
}

fn test_ed25519_inner(k: &[u8], a: &[u8], m: &[u8], s: &[u8]) -> usize {

    let mut out1: [u8; 32] = [0; 32];
    let mut out2: [u8; 64] = [0; 64];
    let mut err: usize = 0;
    ...
    if let Err(e) = Ed25519::verify_oneshot(a, m, s) {
        match e.err_code() {
...
fn test_ed25519_1() -> usize {
    ...
    return test_ed25519_inner(&k[..], &a[..], &m[..], &s[..]);
}

fn test_ed25519_2() -> usize {
    let k: [u8; 32] = [
